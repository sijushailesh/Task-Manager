...
import 'package:flutter_task_planner_app/screens/Project/ProjectList.dart';
...
class HomePage extends StatelessWidget {
  ...
  Widget subheadingRow(String title, Function onTap) {
    return InkWell(
      onTap: () {
        onTap();
      },
                        ...
                        children: <Widget>[
                          Row(
                            ...
                            children: [
                              ...
                              subheadingRow("View All", () {
                                Navigator.of(context).push(MaterialPageRoute(
                                    builder: (_) => ProjectListingScreen()));
                              }),
                            ],
                          ),
                          SizedBox(height: 5.0),
